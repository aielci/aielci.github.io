...
function legal_adviser_lite_setup() {		
	$GLOBALS['content_width'] = apply_filters( 'legal_adviser_lite_content_width', 680 );		
...
define('LEGAL_ADVISER_LITE_THEME_DOC',__('https://gracethemes.com/documentation/legal-adviser-doc/#homepage-lite','legal-adviser-lite'));
define('LEGAL_ADVISER_LITE_LIVE_DEMO',__('https://gracethemes.com/demo/legal-adviser/','legal-adviser-lite'));
 ...
 */
add_action( 'after_setup_theme', 'legal_adviser_lite_setup_woocommerce_support' );
function legal_adviser_lite_setup_woocommerce_support()   
{
